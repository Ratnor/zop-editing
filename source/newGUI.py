        ...
        while mainloop:
            ...
            if endDisplay:
                ...
                if updateHighScores:
                    ...
                    if self.displayedScore > score_1:
                        score_3 = score_2
                        score_2 = score_1
                        score_1 = self.displayedScore
                    elif self.displayedScore > score_2 & self.displayedScore <= score_1:
                        score_3 = score_2
                        score_2 = self.displayedScore
                    elif self.displayedScore > score_3 & self.displayedScore <= (score_2 & score_1):
                        score_3 = self.displayedScore

                    outfile = open('high_scores.txt', 'w')
                    outfile.write(".".join(title) + "1." + str(score_1) + ".\n"+ "2." + str(score_2) + ".\n"+ "3." + str(score_3) + ".\n")
                    outfile.close()
